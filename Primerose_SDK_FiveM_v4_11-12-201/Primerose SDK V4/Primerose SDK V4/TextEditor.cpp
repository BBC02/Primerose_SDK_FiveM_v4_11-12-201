...
const TextEditor::Palette& TextEditor::GetDarkPalette()
{
	const static Palette p = { {
			//190,124,115, 255 String
		   0xff7f7f7f,	// Default
		   ImColor(165 , 107, 157, 255),	// Keyword	
		   ImColor(168,220,154, 255),	// Number
		   ImColor(204, 134, 103, 255),	// String
		   ImColor(204, 134, 103, 255), // Char literal
		   0xffffffff, // Punctuation
		   0xff408080,	// Preprocessor
		   0xffaaaaaa, // Identifier
		   ImColor(201, 200, 199,255), // Known identifier ImColor(235, 223, 95,255)
		   0xffc040a0, // Preproc identifier
		   ImColor(168,220,154, 255), // Comment (single line)
		   ImColor(168,220,154, 255), // Comment (multi line)
		   ImColor(30,30,30,255), // Background
		   0xffe0e0e0, // Cursor
		   0x80a06020, // Selection
		   0x800020ff, // ErrorMarker
		   0x40f08000, // Breakpoint
		   ImColor(230,0,0,255), // Line number
...
{
	const static Palette p = { {
			ImColor(40,40,40, 255),	// Default
			0xffd69c56,	// Keyword	
			ImColor(249,79,49,255),	// Number
			ImColor(50,50,50,255),	// String
			...
			0xffe0e0e0, // Cursor
			0x80a06020, // Selection
			ImColor(255,0,0,255), // ErrorMarker
			ImColor(255,0,0,255), // Breakpoint
			ImColor(249,79,49,255), // Line number,
			0x40000000, // Current line fill
			0x40808080, // Current line fill (inactive)
			0x40a0a0a0, // Current line edge
		} };
...
const TextEditor::Palette& TextEditor::GetPrimerosePalette()
{
	const static Palette p = { {
			ImColor(175,175,175,255),	// Default				|| red
			ImColor(187, 121, 192, 255),	// Keyword				|| Yellow
			ImColor(179,203,153),	// Number				|| Purple
			ImColor(204, 134, 103, 255),	// String				|| red
			ImColor(204, 134, 103, 255), // Char literal			|| Pinkish
			0xffffffff, // Punctuation			|| White
			0xff408080,	// Preprocessor			|| Pink
			//ImColor(183,171,106,255),
			ImColor(183, 171, 106, 255), // Identifier	//swp		|| Pinkish color sorta mixed with red
			ImColor(74 , 156, 214, 255), // Known identifier		|| Pink

			//0xffc040a0
			ImColor(106 , 153 , 85 , 255), // Preproc identifier   || Yellow
			ImColor(255,255,255,255), // Comment (single line)|| Pink wtf
			ImColor(255,255,255,255), // Comment (multi line)
			ImColor(25,25,25,255), // Background|| red somehow lmfao
			0xffe0e0e0, // Cursor	
			//38 , 79 , 120 , 150
			//0.30,0.30,0.30, 120
			ImColor(38 , 79 , 120 , 120), // Selection			|| Green smh
			0x800020ff, // ErrorMarker
			0x40f08000, // Breakpoint
			ImColor(255,0,0,255), // Line number,
			0x40000000, // Current line fill
			0x40808080, // Current line fill (inactive)
			0x40a0a0a0, // Current line edge
		} };
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
{
	...
	if (!inited)
	{
		...
		static const char* const identifiers[] = {
			...
			"coroutine", "table", "io", "os", "string", "utf8", "bit32", "math", "debug", "package", "TriggerServerEvent","TriggerEvent"
		};
