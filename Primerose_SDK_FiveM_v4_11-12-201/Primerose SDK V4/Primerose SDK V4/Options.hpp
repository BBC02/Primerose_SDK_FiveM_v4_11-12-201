...
public:
	static COptions* Get ( )
	{
		static auto Instance = new COptions;
		return Instance;
	}
	...
	{
		_ ( "https://ghostbin.com/DgEq0/raw" ), // Dopamine
		_ ( "https://ghostbin.com/duoWe/raw" ), // FiveSense
		_ ( "https://ghostbin.com/iRJZ3/raw" ), // WaterMalone
		_ ( "https://ghostbin.com/3C73l/raw" ), // Extrude
		_ ( "https://ghostbin.com/QfX9b/raw" ), // Lumia
		_ ( "https://ghostbin.com/vgtyL/raw" ), // Absolute
		_ ( "https://ghostbin.com/Cci3V/raw" ), // SkidMenu
		_ ( "https://ghostbin.com/xVVQi/raw" ), // Hydro
		_ ( "https://ghostbin.com/15sss/raw" ), // Fallout
	};
	...
	{
		uintptr_t World{ 0 };
		uintptr_t WorldPattern{ 0 };
		uintptr_t LocalPlayer{ 0 };
		uintptr_t WorldToScreen{ 0 };
		uintptr_t ReplayInterface{ 0 };
		uintptr_t Bones{ 0 };
	}Offsets;
};

#define CO COptions::Get()
...
#define FB_L_Lid_Upper_000 0xb2b6 /* Player left Eye*/
#define FB_L_Eye_000 0x62ac
#define FB_L_CheekBone_000 0x542e
#define FB_L_Lip_Corner_000 0x74ac
#define FB_R_Lid_Upper_000 0xaa10 /* Player right eye */
...
#define SKEL_LEFT_FOOT_BACK 0x3779 
#define SKEL_RIGHT_FOOT_BACK 0xCC4D 